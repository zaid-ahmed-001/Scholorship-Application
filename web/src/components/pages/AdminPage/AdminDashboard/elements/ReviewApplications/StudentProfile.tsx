  ...
  return (
    ...
    alert(JSON.stringify(data, null, 2));
      ...
      <TabPanel value={0}>
        ...
        <Divider role="presentation" />
        <FormLabel>Download Passport Size Photo</FormLabel>
        <Card
          variant="outlined"
          ...
          <Typography level="body-sm" textAlign="center">
            <Button component="label" variant="plain" >Download Document
        ...
        <FormControl sx={{ display: { sm: 'contents' } }}>
              ...
              {(() => { if (props.currentSemester!=1)  {
                return (
                  <>
                  <Divider role="presentation" />
                  <FormLabel>Download Previous Semester MarkSheet</FormLabel>
                  <Card
                    variant="outlined"
                    sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                    <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
            ...
            <Divider role="presentation" />  
              ...
              {(() => { if (props.Diploma=='Yes')  {
                return (
                  ...
                  <FormLabel>Download Diploma Degree</FormLabel>
                  <Card
                    variant="outlined"
                    sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                    <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
                ...
                return (
                  ...
                  <FormLabel>Download 10th Class MarkSheet</FormLabel>
                  <Card
                    variant="outlined"
                    sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                    <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
                  ...
                  <Divider role="presentation" />
                  <FormLabel>Download 12th Class MarkSheet</FormLabel>
                  <Card
                    variant="outlined"
                    sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                    <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
          ...
          <Box sx={{ pt: 3, pb: 10, display: 'grid', gridTemplateColumns: { xs: '100%', sm: 'minmax(120px, 30%) 1fr', lg: '280px 1fr minmax(120px, 208px)', }, columnGap: { xs: 2, sm: 3, md: 4 }, rowGap: { xs: 2, sm: 2.5 }, '& > hr': { gridColumn: '1/-1', }, }} >
            {
              ...
              <FormLabel>Download Caste Certificate</FormLabel>
              <Card
                variant="outlined"
                sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
      ...
      <form  
          ...
          <TabPanel value={3}>
            <Box sx={{ pt: 3, pb: 10, display: 'grid', gridTemplateColumns: { xs: '100%', sm: 'minmax(120px, 30%) 1fr', lg: '280px 1fr minmax(120px, 208px)', }, columnGap: { xs: 2, sm: 3, md: 4 }, rowGap: { xs: 2, sm: 2.5 }, '& > hr': { gridColumn: '1/-1', }, }} >
              ...
              <Divider role="presentation" />
              <FormLabel>Download Income Certificate</FormLabel>
              <Card
                variant="outlined"
                sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
                <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
    ...
    <>
      ...
      <TabPanel value={4}>
        <Box sx={{ pt: 3, pb: 10, display: 'grid', gridTemplateColumns: { xs: '100%', sm: 'minmax(120px, 30%) 1fr', lg: '280px 1fr minmax(120px, 208px)', }, columnGap: { xs: 2, sm: 3, md: 4 }, rowGap: { xs: 2, sm: 2.5 }, '& > hr': { gridColumn: '1/-1', }, }} >
          ...
          <Divider role="presentation" />
          <FormLabel>Download Samagra Certificate</FormLabel>
          <Card
            variant="outlined"
            sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
            <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
      ...
      onSubmit={(event: React.FormEvent<NativeFormElement>) => {
        ...
        <TabPanel value={5}>
          ...
          >
            ...
            <Divider role="presentation" />
            <FormLabel>Download Domicile Certificate</FormLabel>
            <Card
              variant="outlined"
              sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
              <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
...
export default function StudentProfile() {
  ...
  const [ScholarshipDocument , setScholarshipDocument] = React.useState<File | null>(null);
  const [ScholarshipDocumentuploadProgress, setScholarshipDocumentuploadProgress] = React.useState(0);
  return (
    ...
    >
      <Typography level="h1" fontSize="xl2" sx={{ mb: 1, paddingLeft: 2}}>Profile: 
        <Typography color='primary' > {enrollmentNumber}</Typography>
        <Box sx={{ display: { xs: 'flex', sm: 'none' }, flexDirection: 'row-reverse',justifySelf: 'flex-end', position: 'absolute', top: 4, right: 15}}>
            <Button  variant="soft" color="neutral" name='PersonalSubmit' type='submit' size="sm" onClick={ () => navigate('../ViewApplications') }>Back</Button>
        </Box>
      </Typography>
      <Tabs value={tabIndex} onChange={(event, value) => settabIndex(value as number)} sx={{ bgcolor: 'transparent' }}>
        ...
        > 
          ...
          <Tab indicatorInset value={1} disabled={false} >
            Academic Details
          </Tab>
          <Tab indicatorInset value={2} disabled={false} >
            Caste & Composite
          </Tab>
          <Tab indicatorInset value={3} disabled={false} >
            Income Details
          </Tab>
          <Tab indicatorInset value={4} disabled={false} >
            Samagra Details
          </Tab>
          <Tab indicatorInset value={5} disabled={false} >
            Native Declaration
          </Tab>
          <Tab indicatorInset value={6} disabled={false} >
            Scholarship Documents
          </Tab>
          <Tab indicatorInset={false} disabled={false} >
            <Box sx={{ display: { xs: 'none', sm: 'flex' }, flexDirection: 'row-reverse',justifySelf: 'flex-end'}}>
                <Button variant="soft" color="neutral" name='PersonalSubmit' type='submit' size="sm" onClick={ () => navigate('../ViewApplications') }>Back</Button>
            </Box>
          </Tab>
        </TabList>
        ...
        <TabPanel value={6}>
          ...
          <FormLabel>Download Scholarship Documents</FormLabel>
            <Card
            variant="outlined"
            sx={[{borderRadius: 'sm', display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center', px: 3, flexGrow: 1}]}>
            <Box sx={{ p: 1, bgcolor: 'background.level1', borderRadius: '50%' }}>
            ...
            <Typography level="body-sm" textAlign="center">
                <Button component="label" variant="plain" >Download Document
                <input name='ScholarshipDocument' accept=".pdf" type="file" style={{opacity: '0',position: 'absolute'}} required={ (ScholarshipDocument==null) ? true : false } />
                </Button>
                {ScholarshipDocument && <Box>&nbsp;{ScholarshipDocument?.name}</Box>}
            </Typography>
            </Card>
            {(ScholarshipDocumentuploadProgress!=0) && (
            <>
            <Divider role="presentation" />
            <FormControl sx={{ display: { sm: 'contents' } }}>
            <FormLabel></FormLabel>
                <FileUpload
                    fileName={ScholarshipDocument?.name as string}
                    fileSize={ScholarshipDocument?.size}
                    progress={ScholarshipDocumentuploadProgress}
                />
            </FormControl>
            </>
            )}
